...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <ol class="round">
        ...
        <li class="two">
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:QuanLyBanHang_Group9_INF205ConnectionString7 %>" DeleteCommand="DELETE FROM [SanPham] WHERE [id_sp] = @id_sp" InsertCommand="INSERT INTO [SanPham] ([id_sp], [name], [price], [description], [LoaiSanPham_sku]) VALUES (@id_sp, @name, @price, @description, @LoaiSanPham_sku)" SelectCommand="SELECT [id_sp], [name], [price], [description], [LoaiSanPham_sku] FROM [SanPham]" UpdateCommand="UPDATE [SanPham] SET [name] = @name, [price] = @price, [description] = @description, [LoaiSanPham_sku] = @LoaiSanPham_sku WHERE [id_sp] = @id_sp">
                <DeleteParameters>
        ...
        <li class="three">
            ...
            <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:QuanLyBanHang_Group9_INF205ConnectionString8 %>" SelectCommand="SELECT [HoaDon_id_hd], [SanPham_id_sp], [so_luong], [amount] FROM [ChiTietHoaDon]"></asp:SqlDataSource>
        </li>
        <li class="four">
            <h5>Loại Sản Phẩm</h5>
            ...
            <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:QuanLyBanHang_Group9_INF205ConnectionString9 %>" DeleteCommand="DELETE FROM [LoaiSanPham] WHERE [sku] = @sku" InsertCommand="INSERT INTO [LoaiSanPham] ([sku], [name_sku]) VALUES (@sku, @name_sku)" SelectCommand="SELECT [sku], [name_sku] FROM [LoaiSanPham]" UpdateCommand="UPDATE [LoaiSanPham] SET [name_sku] = @name_sku WHERE [sku] = @sku">
                <DeleteParameters>
